...
As of v0.5.0 (2026-06-01), against two reference anchors — the e-commerce
...
22 / 129 raw). v0.5.0 also ships a SaaS demo pack (12 tables / 84 columns)
...
- ✅ Continuous integration (lint + unit + integration with 99% coverage
  gate; 5275 tests on `main` at the v0.5.0 cut)
