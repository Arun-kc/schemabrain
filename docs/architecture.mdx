...
<CardGroup cols={1}>
  <Card title="Launch interactive diagram ↗" icon="arrow-up-right-from-square" href="/architecture-live">
    Switch between 4 scene modes — MCP flow · PII refusal · indexing pipeline · audit chain — with animated data pulses on each connector.
  </Card>
</CardGroup>
