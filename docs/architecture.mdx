...
<Frame caption="Static high-res render. For the live 4-tab interactive scene with animated pulses, use the launch button below.">
  <img
...
<div style={{ display: "flex", justifyContent: "center", margin: "1.5rem 0" }}>
  <button
    ...
    style={{
      ...
      boxShadow: "0 1px 0 rgba(255,255,255,0.15) inset, 0 4px 14px rgba(62, 207, 142, 0.35)"
    }}
  >
...
>
  ...
  >
    <button
      ...
      aria-label="Close interactive architecture diagram"
      style={{
        position: "absolute",
        top: "12px",
        right: "12px",
    ...
    <header class="scene-header">
      <div class="brand-mark">
        ...
        <div class="brand-text">
          ...
          <span class="tag">SQL Firewall · v1.0</span>
        </div>
      </div>
...
<Note>
Until v2 ships, treating SchemaBrain as a safety layer would be premature. The v0 surface gives agents better schema context, not better SQL safety. The v0.4 release adds the read-only refusal envelope as a partial down-payment on the v2 vision.
</Note>
