...
<Frame>
  <img
    ...
    alt="SchemaBrain architecture: agent talks to SchemaBrain over MCP stdio; SchemaBrain emits parameterized SQL to Postgres; the SchemaBrain boundary is the trust boundary."
  />
  <img
    className="hidden dark:block"
    src="/assets/readme-architecture-dark.svg"
    alt="SchemaBrain architecture: agent talks to SchemaBrain over MCP stdio; SchemaBrain emits parameterized SQL to Postgres; the SchemaBrain boundary is the trust boundary."
  />
</Frame>
