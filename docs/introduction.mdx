...
<Steps>
  ...
  <Step title="Initialize">
    ...
    schemabrain init
    ```
    The wizard detects your installed MCP hosts (Claude Desktop, Claude Code, Cursor, Windsurf) and shows a menu — press Enter for the detected default, or pass `--host X` to skip the prompt. It spins up a local Postgres demo with a 7-table e-commerce schema and writes a ready-to-use config. Press Enter at every prompt for the demo defaults.
  </Step>
