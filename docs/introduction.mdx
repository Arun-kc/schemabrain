...
<Steps>
  ...
  <Step title="Initialize">
    ...
    schemabrain init
    ```
    The wizard auto-detects your MCP host (Claude Desktop, Cursor, Windsurf, Claude Code), spins up a local Postgres demo with a 7-table e-commerce schema, and writes a ready-to-use config. Press Enter at every prompt for the demo defaults.
  </Step>
