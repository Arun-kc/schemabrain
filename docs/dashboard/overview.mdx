...
<Frame caption="Audit Viewer — the tamper-evident chain spined by a derived Merkle root, with each row's inclusion proof recomputed in the browser and reconciled to one root.">
