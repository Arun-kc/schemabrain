---
title: "CLI reference"
description: "Nineteen top-level subcommands span the zero-setup demo, indexing, serving, semantic-layer curation, audit, and the local dashboard. This page is the catalog; per-command pages cover flags and behaviour."
---
...
A `.env` file in your working directory is auto-loaded at startup (shell
exports win; a missing `.env` is a silent no-op), and several commands
auto-resolve their inputs from the environment:
