...
_SERVER_INSTRUCTIONS = (
    ...
    "`get_metric(name, ...)` to compute the answer. Do not guess "
    "table or column names. Do not call `list_tables` — that tool "
    "does not exist; use `find_relevant_tables` or "
    "`find_relevant_entities` instead. "
